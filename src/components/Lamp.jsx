        ...
        <>
            ...
            <section className='w-full h-[40vh] flex flex-wrap px-[50px] relative'>
                ...
                <div className='w-full h-full flex flex-wrap relative z-[2] content-center'>
                    <h1 className='w-full h-fit py-[20px] font-futuram text-white text-[28px]'>Lamps</h1>
                    <p className='w-1/2 h-fit font-futuras py-[10px] text-white'>Here you'll find a handpicked selection of lamps that meet all style preferences and needs. From iconic design lamps to innovative LED lamps, our collection offers something for every home. Welcome to explore and find the perfect lamp that reflects your personal style.</p>
                </div>
            </section>
