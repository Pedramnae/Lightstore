...
import banner from './../assets/img/Accessoriesbanner.jpg'
    ...
    return (
        <>
            ...
            <section className='w-full h-[40vh] flex flex-wrap  px-[50px] relative'>
                ...
                <div className='w-full h-full flex flex-wrap relative z-[2] items-center'>
                    <h1 className='w-full h-fit py-[20px] font-futuram text-white text-[28px]'>Lighting Accessories</h1>
                </div>
            </section>
