...
import banner from './../assets/img/lampbanner.jpg'
    ...
    return (
        <>
            ...
            <section className='w-full h-[40vh] flex flex-wrap  px-[50px]  relative'>
                ...
                <div className='w-full h-full flex flex-wrap z-[2] content-center'>
                    <h1 className='w-full h-fit py-[20px] font-futuram text-white text-[28px]'>Light Sources</h1>
                    <p className='w-1/2 h-fit font-futuras py-[10px] text-white'>To get the most out of your lamp, it's important to choose the right light source. With well-chosen light sources, you get a pleasant glow that provides good color rendering and does justice to your lamp.</p>
                </div>
            </section>
            <section className='w-full h-fit py-[40px] flex flex-wrap justify-center'>
                <div className='w-[95%] md:w-[85%] h-[90%] flex flex-wrap content-between justify-between'>
                    {mydata && mydata.map((item) => {
                        if (item.category == 'Light Sources') {
                            return (
