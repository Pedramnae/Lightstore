...
import banner from './../assets/img/smarthomebanner.jpg'
...
function Smarthome() {
    ...
    return (
        <>
            <Header />
            <section className='w-full h-[40vh] flex flex-wrap  px-[50px] items-center relative'>
                <figure className='w-full h-full absolute top-0 left-0'>
                    <img className='w-full h-full object-cover' src={banner} alt="" />
                </figure>
                <div className='w-full h-full flex items-center relative z-[2]'>
                    <h1 className='w-full h-fit py-[20px] font-futuram text-white text-[28px]'>Smart Home</h1>
                </div>
            </section>
